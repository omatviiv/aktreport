    ...
    if (!existsSync(aktLocation)) {
      ...
      pdf
        ...
        .text(`1. Сторони по даному Акту підтверджують, що станом на ${
          ...
          cYear
        }р. Виконавцем фактично надані, а Замовником прийняті послуги згідно Договору про надання послуг № 1/010919 від 02 вересня 2019р. (надалі - Договір):`, {
          align: 'justify',
        })
        .text(tasksList, {
          indent: 20,
        ...
        .text('6. Даний Акт складено українською мовою за вийнятком назв завдань, які подані мовою оригіналу - англійською, в двох примірниках по одному для кожної із сторін, є невід’ємною частиною Договору про надання послуг № 1/010919 від 02 вересня 2019 р.')
        .moveDown(2)
        .font(fontBold)
